...
coleccionProductos = db.ref().child('productos');
 ...
 coleccionProductos.once('value', function(snapshot) {
  snapshot.forEach(function(childSnapshot) {
    // Obtén los datos de cada producto
    var producto = childSnapshot.val();
    
    // Crea un elemento HTML para mostrar el producto
    var productoHTML = `
    ...
    // Agrega el elemento HTML del producto al contenedor de productos
